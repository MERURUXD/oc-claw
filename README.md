...
<p align="center">
  <b>Coding agent monitor · Codex sprite pets or Shenshen video pet</b><br/>
  <sub>macOS: OpenClaw, Claude Code, Cursor, Codex, OpenCode, Gemini CLI, Google Antigravity, Hermes Agent</sub><br/>
  <sub>Windows: OpenClaw, Claude Code, Cursor, Codex, OpenCode, Gemini CLI, Google Antigravity, Hermes Agent (remote SSH)</sub>
</p>
<p align="center">
...
- Reacts to OpenClaw / Claude Code / Codex / Cursor / Gemini CLI / Google Antigravity / Hermes Agent activity in real time (working, idle, waiting)
...
- Listens to local Claude Code, Codex, Cursor, Gemini CLI, and Google Antigravity sessions via hooks, view live conversations
...
- macOS or Windows
- [OpenClaw](https://github.com/nicepkg/openclaw), [Claude Code](https://docs.anthropic.com/en/docs/claude-code), [Codex](https://github.com/openai/codex), [Cursor](https://www.cursor.com), [Gemini CLI](https://github.com/google-gemini/gemini-cli), [Google Antigravity](https://antigravity.google), and/or [Hermes Agent](https://github.com/NousResearch/hermes-agent) installed
...
Google Antigravity ──→ Hooks ──→ Event parser ──→ Activity state
Hermes Agent       ──→ Plugin ──→ Event parser ──→ Activity state
                                                    ↓
                    Animated sprites ← State machine ← Sound effects
```

OC-Claw polls OpenClaw session files to detect agent activity, and listens to Claude Code, Codex, Cursor, Gemini CLI, Google Antigravity, and Hermes Agent via installed hooks/plugins. Activity states drive character animations on the notch island (macOS) or taskbar area (Windows), with an expandable panel for session details, chat history, and metrics.
